...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../index.php">Hello &nbsp<?php echo ucfirst($_COOKIE['username']); ?></a>
    </div>
    <!-- Top Menu Items -->
    <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user "></i>&nbsp<?php echo $_COOKIE['username']; ?><b class="caret"></b></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <hr>
                    <input type="submit" class="btn btn-danger btn-raised col-md-4 col-md-offset-4" value="Update">
                    <br>
                    <br>
                </form>
            </div> <!--modal-body-->
